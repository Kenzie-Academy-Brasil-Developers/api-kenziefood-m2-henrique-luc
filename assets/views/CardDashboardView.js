    ...
    template() {
        return `
            <li class="admim__box-lista__lista" id=${this._produto.id}>
                ...
                <div>
                    <svg width="14" height="13" class="admim__box-lista__lista__botao-alterar" viewBox="0 0 14 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                ...
                <svg width="11" height="13" class="admim__box-lista__lista__botao-lixeira" viewBox="0 0 11 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
