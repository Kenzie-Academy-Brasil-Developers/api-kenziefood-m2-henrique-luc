const CardDashboard = class CardDashboardView {
    ...
    template() {
        return `
            <li class="admim__box-lista__lista" id=${this._produto.id}>
